...
#define kRecord @"myRecord.caf"
@interface fourViewController ()<AVAudioRecorderDelegate,AVAudioPlayerDelegate>
...
-(NSURL *)getSavePath{
    ...
    urlStr=[urlStr stringByAppendingPathComponent:kRecord];
